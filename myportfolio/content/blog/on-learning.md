...
In periods of stress and variance, I crave stability. In periods of consistency and routine, I crave variance. On one hand, I believe consistency is the root of progress, but on the other hand, I chase paths that increase the variance of my life. One moves you towards a destination while the other also moves you somewhere, but you just don’t really know where. 
...
One could argue that you ought to optimize for living. In a way, it makes sense but I feel it’s a juxtaposition. To me, the words living is the epitome of freedom while optimization is the antithesis, though the lines are far more blurred than black and white. I think the stem of all of this is not having clearly defined values for this period of my life. 

So let’s figure this out. 

I’ve always told myself that purpose and people are the top values in my life. This still holds true, but I need to be more explicit. Currently, it’s Fall Term 2025 and also pledge term. I started off the term trying to optimize for making new friends and growing closer with older friends. In turn, I took the gas off of recruiting, the gym, and research. Yet I’m always itching to keep building, reading, learning and researching. 

Two years ago, I built a framework for balance that I still hold to be true today. You need imbalance in your life to push limits, but we can find this imbalance via a balanced amount of imbalance. What this means is that I can designate periods of my life to place some values higher and others lower. 

It’s getting late so let’s wrap this up. We’re getting close. When considering opportunity cost, I can always build and research but I can’t always recruit or go through pledge term again or enjoy the fall foliage of New Hampshire. I won’t always have the chance to do stupid things with my friends and blame it on “pledge tasks” or go on midnight hikes with friends or go jumping in bouncy houses on random Friday nights. 
...
Adaptional part-time LLM Research
Recruiting (20% leetocde, 20% applying, 60% meeting cool ppl in tech)
Gym(and basketball now too)
Read/experiment interesting blogs on ai, vc and current tech trends
Learn for the sake of learning–not for grades. For my classes, I’ll learn to the extent where my interests fade. 
